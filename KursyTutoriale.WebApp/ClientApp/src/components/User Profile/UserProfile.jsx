...
import { Container, Row, Col, Button,  Nav,
   NavLink, NavItem, 
    Jumbotron, Media, Badge,
  TabContent, TabPane, Progress, Spinner
} from 'reactstrap';
import './style.css';
...
class UserProfile extends React.Component {
    ...
    componentWillMount(){
      ...
      CourseService.getUsersCourses(this.state.userid).then(
        result => this.setState({courseList: result, numberOfCourses:result.length}),
        error => console.log(error)
      )
    }
    ...
    loadMore(){
      ...
      this.setState({numOfVisibleCourses:this.state.numOfVisibleCourses+numOfCoursesLoading}) }
    }
      ...
      <Container className="col_bg about">
        <Row>
          ...
          <Container>
            <Row>   
              <Media
                src="https://www.w3schools.com/howto/img_avatar.png" style={{width:"100%",height:"100%"}} alt="Generic placeholder image" />
                <hr width="100%"></hr>
            </Row>
            <Row>
          ...
          <Container className="right_side">
            <Row>
              ...
              <Col>
                ...
                <Button color="primary" className="float-right"><span role="img" aria-label="text-bubble">💬</span> Send message</Button>
              ...
              <Badge className="badge" color={this.state.courses_color}>{this.state.numberOfCourses}</Badge>
            ...
            <Row>
                ...
                <NavItem>
                  <NavLink
                    ...
                    onClick={() => { this.toggle('1'); }}>
                      <l class="stats"><span role="img" aria-label="silhouethe">👤</span> About</l>
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink
                    ...
                    onClick={() => { this.toggle('2'); }}>
                      <l class="stats"><span role="img" aria-label="list">📝</span> Courses</l>
                  </NavLink>
                </NavItem>
                </Nav>
              <TabContent activeTab={this.state.activeTab}>
                ...
                <TabPane tabId="2">
                  ...
                  <Col>
                    {this.state.courseList.slice(0,this.state.numOfVisibleCourses).map((course,index)=>{
                      return(
                        <Row sm="6">
                    ...
                    <Button onClick={()=>this.loadMore()} style={{marginTop:"5px"}}>See More</Button>
                  </Col>  }
              </TabPane>
              </TabContent>
            </Container>
