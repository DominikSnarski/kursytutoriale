...
import { CustomInput, Form, FormGroup, Label, Container, Row, Col, Button } from 'reactstrap';
                    ...
                    <Col>
                        <FormGroup>
                            ...
                            <div>
                                ...
                                <CustomInput type="checkbox" id="priceLessThan10" label="Less than 10$" />
                                <CustomInput type="checkbox" id="priceFrom10To50" label="10-50$" />
                                <CustomInput type="checkbox" id="priceFrom50To100" label="50-100$" />
                                <CustomInput type="checkbox" id="priceMoreThan100" label="More than 100$" />
                            </div>
                        </FormGroup>
